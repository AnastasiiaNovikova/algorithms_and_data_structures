/*
Submit a solution for B-Турнирная таблица индивидуалов
 Time limit:	2 s
 Real time limit:	5 s
 Memory limit:	64M
 ...
 Notes
 В случае решения задачи без структур данных или с использованием STL, - задача оценивается в половину стоимости; в случае использовании структур данных: АВЛ-дерево, хэш-таблицы или бинарная куча, задача оценивается стандартно.
*/
